...
fileName2<-paste(training_home,fileName2,sep="")
Features<-read.table(fileName2)

# (c) activity labels
fileName3<-"y_train.txt"
fileName3<-paste(training_home,fileName3,sep="")
labels<-read.table(fileName3)

# (d) labels for features
fileName4<-"features.txt"
fileName4<-paste(data_home,fileName4,sep="")
...
fileName5<-paste(data_home,fileName5,sep="")
...
fileName1<-paste(testing_home,fileName1,sep="")
id<-read.table(fileName1)

# (b) features
fileName2<-"X_test.txt"
fileName2<-paste(testing_home,fileName2,sep="")
Features<-read.table(fileName2)

# (c) activity labels
fileName3<-"y_test.txt"
fileName3<-paste(testing_home,fileName3,sep="")
labels<-read.table(fileName3)
...
write.table(TrainTestData,file="HAR_TidyData2.txt")



write.csv(combinedData,file="HAR_TidyDataIntermediate.csv",row.names=FALSE)
write.csv(TrainTestData,file="HAR_TidyData.csv",row.names=FALSE)
